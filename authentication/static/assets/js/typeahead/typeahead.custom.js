(function ($) {
  ...
  var bestPictures = new Bloodhound({
    ...
    remote: {
      url: "/core/static/assets/js/typeahead/data/films/queries/%QUERY.json",
      wildcard: "%QUERY",
    },
  });
  ...
  var nflTeams = new Bloodhound({
    ...
    prefetch: "/core/static/assets/js/typeahead/data/nfl.json",
  });
  ...
  var nhlTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace("team"),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: "/core/static/assets/js/typeahead/data/nhl.json",
  });
