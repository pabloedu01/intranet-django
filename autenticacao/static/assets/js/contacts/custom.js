  ...
  if ($("#bookmark-form").valid()) {
    ...
    var tablist =
      ...
      ')" href="#v-pills-user" role="tab" aria-controls="v-pills-user" aria-selected="true" data-original-title="" title="">\
			                <div class="media">\
				                <img class="img-50 img-fluid m-r-20 rounded-circle update_img_0" src="/core/static/assets/images/user/user.png" alt="" data-original-title="" title="">\
    ...
    var tabcontent =
      ...
      ' tab-content-child fade show active" id="v-pills-user" role="tabpanel" aria-labelledby="v-pills-user-tab">\
		                <div class="profile-mail">\
		                  <div class="media">\
		                  <img class="img-100 img-fluid m-r-20 rounded-circle update_img_0" src="/core/static/assets/images/user/user.png" alt="" data-original-title="" title="">\
