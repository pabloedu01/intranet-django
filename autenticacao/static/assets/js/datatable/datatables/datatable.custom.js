$(document).ready(function () {
  ...
  $("#advance-8").DataTable({
    language: {
      url: "/core/static/assets/json/German.json",
    },
  });
  $("#advance-9").DataTable({
    searching: false,
  ...
  $("#data-source-2").DataTable({
    ajax: "/core/static/assets/ajax/arrays.txt",
  });
  var dataSet = [
    [
      "Tiger Nixon",
  ...
  $("#data-source-4").DataTable({
    processing: true,
    serverSide: true,
    ajax: "/core/static/assets/json/server-side.json",
  });
  ...
  var ct = $("#API-chield-row").DataTable({
    ajax: "/core/static/assets/ajax/api.txt",
    columns: [
      {
  ...
  $("#ajax-data-object").DataTable({
    ajax: "/core/static/assets/ajax/object.txt",
    columns: [
      {
        data: "name",
      },
  ...
  $("#ajax-data-nested-object").DataTable({
    processing: true,
    ajax: "/core/static/assets/ajax/object_nested.txt",
    columns: [
      {
        data: "name",
      },
  ...
  $("#orthogonal-data").DataTable({
    ajax: "/core/static/assets/ajax/orthogonal.txt",
    columns: [
      {
        data: "name",
      },
  ...
  $("#server-side-datatable").DataTable({
    processing: true,
    serverSide: true,
    ajax: "/core/static/assets/ajax/server-processing.php",
  });
  ...
  $("#datatable-http").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "/core/static/assets/ajax/server-processing.php",
      data: function (d) {
        d.myKey = "myValue";
      },
    },
  ...
  $("#datatable-post").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "/core/static/assets/ajax/post.php",
      type: "post",
    },
    columns: [
      {
